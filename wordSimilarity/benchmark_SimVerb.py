...
if __name__ == '__main__':
    ...
    result_file = open("/home/nishanthini/FYP/Evaluations/BenchMarkMyWork/wordSimilarity/SimVerb.txt", "w")
    for line in open(word_sim_file, 'r'):
        ...
        if c > 0:
            ...
            result_file.writelines(word1 + "\t" + word2 + "\t" + str(val) + "\t" + str(final_sim_val) + "\t" + key_word1 +
                                   "\t" + key_word2)
